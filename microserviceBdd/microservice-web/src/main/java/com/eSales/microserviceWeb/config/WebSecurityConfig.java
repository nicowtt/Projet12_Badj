package com.eSales.microserviceWeb.config;

import com.eSales.microserviceWeb.security.JwtAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // dont authenticate this particular request
                .authorizeRequests().antMatchers( "/AfterTodaySales", "/checkUserLogIn").permitAll().
