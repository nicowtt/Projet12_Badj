...
export class ArticlesService {
   ...
   */
  getAllArticlesForOneUser(userEmail: string, onSucces: Function) {
    return this.http
  ...
  /**
     ...
     * @param userEmail (current user email)
     */
    getAllArticlesForOnesaleAndOneUser(saleId: number, userEmail: string, onSucces: Function) {
      return this.http
      .get<any[]>('/getAllArticleForOneUserAndOneSale/' + saleId + '/' + userEmail)
      .subscribe(
          (response) => {
              this.articles = response;
              this.emitArticles();
